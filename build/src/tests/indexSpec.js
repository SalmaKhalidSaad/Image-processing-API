...
describe("testing resizeImage", function () {
    it("Test if image size is adequate", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect(function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, mw_1.resizeImage)(10, 10, "image")];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
...
describe('Test endpoint responses', function () {
    it('gets the api endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/image?length=20&width=30&name=image')];
                case 1:
                    res = _a.sent();
                    expect(res).toBeTrue;
                    return [2 /*return*/];
    ...
    it('gets the api endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/image?length=7000&width=30&name=image')];
                case 1:
                    res = _a.sent();
